...
enum KName {
  ...
  Builtin_MLReg_Dropout,
  Builtin_MLReg_WeightDecay,
  Builtin_MLReg_L1Lasso,
  Builtin_MLReg_L2Ridge,
  Builtin_MLReg_ElasticNet,
  Builtin_MLOptim_RMSProp,
  Builtin_MLOptim_Adadelta,
  Builtin_MLOptim_Adagrad,
  Builtin_MLOptim_Adamax,
  Builtin_MLOptim_Adam,
  Builtin_MLOptim_Nadam,
  Builtin_MLOptim_SGD,
  Builtin_MLOptim_SGDNesterov,
